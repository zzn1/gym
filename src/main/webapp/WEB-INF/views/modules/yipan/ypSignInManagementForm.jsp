...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/yipan/ypSignInManagement/">打卡记录列表</a></li>
		<li class="active"><a href="${ctx}/yipan/ypSignInManagement/form?id=${ypSignInManagement.id}">打卡记录<shiro:hasPermission name="yipan:ypSignInManagement:edit">${not empty ypSignInManagement.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="yipan:ypSignInManagement:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="ypSignInManagement" action="${ctx}/yipan/ypSignInManagement/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="yipan:ypSignInManagement:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
